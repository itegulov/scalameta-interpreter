  ...
  implicit class ScalametaSymbol(tree: Tree)(implicit mirror: ScalametaMirror) {
    def symbol: Symbol = {
      tree match {
        ...
        case Ctor.Ref.Name("StringContext") => Symbol.Global(Symbol.Global(Symbol.Global(Symbol.None, Signature.Term("_root_")), Signature.Term("scala")), Signature.Term("StringContext"))
